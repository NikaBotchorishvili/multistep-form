...
function Form() {
	...
	const { step, finished } = useContext(Context) as Required<
		Partial<ContextType>
	>;
	return (
		<>
			<main className="flex md:flex-row flex-col h-[600px] shadow-none md:shadow-lg w-[1000px] justify-around p-5 bg-opacity-0 md:bg-opacity-100 bg-White rounded-3xl">
				<Sidebar />
